...
const NovoAtendimentoModal = ({ opened, onClose, onSave }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    processo: '',
    relato: 'não estou recebendo o medicamento na secretária de saúde. Me informaram que o remédio está em falta e sem previsão de chegar.',
    providencia: 'Retorno',
    detalhesProvidencia: 'deve retornar com lista padrão de documentos',
    formaAtendimento: 'Atendimento presencial na sede da Defensoria',
    isUrgente: false,
  });
